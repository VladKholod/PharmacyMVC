...
intellisense.annotate(jQuery, {
  ...
  'dequeue': function() {
    /// <signature>
    ///   <summary>Init the next function on the queue for the matched element.</summary>
  ...
  'globalEval': function() {
    /// <signature>
    ///   <summary>Init some JavaScript code globally.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'dequeue': function() {
    /// <signature>
    ///   <summary>Init the next function on the queue for the matched elements.</summary>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'trigger': function() {
    /// <signature>
    ///   <summary>Init all handlers and behaviors attached to the matched elements for the given event type.</summary>
  ...
  'triggerHandler': function() {
    /// <signature>
    ///   <summary>Init all handlers attached to an element for an event.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript event type, such as click or submit.</param>
